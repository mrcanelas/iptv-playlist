...
module.exports = {
  ...
  days: 3,
  request: { headers, timeout: 10000, },
  url: function ({ date, channel }) {
    const startOfDay = Math.floor(dayjs(date).startOf('day').unix())
    const endOfDay = Math.floor(dayjs(date).endOf('day').unix())
    
    return `https://www.clarotvmais.com.br/avsclient/1.2/epg/livechannels?types=&channelIds=${channel.site_id}&startTime=${startOfDay}&endTime=${endOfDay}&location=SAO%20PAULO,AMAZONAS&channel=PCTV`
  },
...
//https://www.clarotvmais.com.br/avsclient/1.2/epg/livechannels?types=&channelIds=316&startTime=1770681600&endTime=1770767999&location=SAO%20PAULO,AMAZONAS&channel=PCTV
//https://www.clarotvmais.com.br/avsclient/1.2/epg/livechannels?types=&channelIds=316&startTime=1770681600&endTime=1770767999&location=SAO%20PAULO,AMAZONAS&channel=PCTV
